...
import MemParent from './components/memoize/MemParent'; // Memoize
import LazyParent from './components/lazy/LazyParent'; // Lazy Loading
         ...
         <Router>
            <div className="App">
               ...
               <Switch>
                  ...
                  <Route path="/memoize" exact strict component={MemParent}/>
                  <Route path="/lazy-loading" exact strict component={LazyParent}/>
